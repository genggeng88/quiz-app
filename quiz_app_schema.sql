...
CREATE TABLE quizquestion (
  ...
  quiz_id        BIGINT NOT NULL REFERENCES quiz(quiz_id) ON DELETE CASCADE,
...
-- ===== Helpful indexes =====
CREATE INDEX idx_question_category ON question(category_id) WHERE is_active;
...
CREATE INDEX idx_quiz_time_start ON quiz(time_start DESC);
...
INSERT INTO "user"(email, password_hash, firstname, lastname, is_admin) VALUES
...
-- ===== Math =====
INSERT INTO question(category_id, description) SELECT category_id, 'What is 7 × 6?' FROM category WHERE name='Math';
WITH q AS (SELECT question_id FROM question ORDER BY question_id DESC LIMIT 1)
...
INSERT INTO question(category_id, description) SELECT category_id, 'Derivative of x²?' FROM category WHERE name='Math';
WITH q AS (SELECT question_id FROM question ORDER BY question_id DESC LIMIT 1)
INSERT INTO choice(question_id, description, is_correct)
SELECT q.question_id, x.description, x.correct FROM q, (VALUES ('2x',TRUE),('x',FALSE),('x²',FALSE),('1',FALSE)) AS x(description,correct);

INSERT INTO question(category_id, description) SELECT category_id, 'Value of π (rounded)?' FROM category WHERE name='Math';
WITH q AS (SELECT question_id FROM question ORDER BY question_id DESC LIMIT 1)
INSERT INTO choice(question_id, description, is_correct)
...
INSERT INTO question(category_id, description) SELECT category_id, 'What is 15% of 200?' FROM category WHERE name='Math';
WITH q AS (SELECT question_id FROM question ORDER BY question_id DESC LIMIT 1)
INSERT INTO choice(question_id, description, is_correct)
SELECT q.question_id, x.description, x.correct FROM q, (VALUES ('30',TRUE),('20',FALSE),('15',FALSE),('25',FALSE)) AS x(description,correct);

INSERT INTO question(category_id, description) SELECT category_id, 'Solve: 2x = 10' FROM category WHERE name='Math';
WITH q AS (SELECT question_id FROM question ORDER BY question_id DESC LIMIT 1)
INSERT INTO choice(question_id, description, is_correct)
...
INSERT INTO question(category_id, description) SELECT category_id, 'Area of a circle formula?' FROM category WHERE name='Math';
WITH q AS (SELECT question_id FROM question ORDER BY question_id DESC LIMIT 1)
INSERT INTO choice(question_id, description, is_correct)
SELECT q.question_id, x.description, x.correct FROM q, (VALUES ('πr²',TRUE),('2πr',FALSE),('πd',FALSE),('r²',FALSE)) AS x(description,correct);

INSERT INTO question(category_id, description) SELECT category_id, 'What is the square root of 144?' FROM category WHERE name='Math';
WITH q AS (SELECT question_id FROM question ORDER BY question_id DESC LIMIT 1)
INSERT INTO choice(question_id, description, is_correct)
SELECT q.question_id, x.description, x.correct FROM q, (VALUES ('12',TRUE),('14',FALSE),('10',FALSE),('16',FALSE)) AS x(description,correct);

INSERT INTO question(category_id, description) SELECT category_id, 'What is 9³?' FROM category WHERE name='Math';
WITH q AS (SELECT question_id FROM question ORDER BY question_id DESC LIMIT 1)
INSERT INTO choice(question_id, description, is_correct)
SELECT q.question_id, x.description, x.correct FROM q, (VALUES ('729',TRUE),('81',FALSE),('243',FALSE),('27',FALSE)) AS x(description,correct);

INSERT INTO question(category_id, description) SELECT category_id, 'What is the next prime after 7?' FROM category WHERE name='Math';
WITH q AS (SELECT question_id FROM question ORDER BY question_id DESC LIMIT 1)
INSERT INTO choice(question_id, description, is_correct)
SELECT q.question_id, x.description, x.correct FROM q, (VALUES ('11',FALSE),('13',FALSE),('17',FALSE),('11',TRUE)) AS x(description,correct);

INSERT INTO question(category_id, description) SELECT category_id, 'What is the value of 0!' FROM category WHERE name='Math';
WITH q AS (SELECT question_id FROM question ORDER BY question_id DESC LIMIT 1)
INSERT INTO choice(question_id, description, is_correct)
...
-- ===== Physics =====
INSERT INTO question(category_id, description) SELECT category_id, 'Acceleration due to gravity (m/s²)?' FROM category WHERE name='Physics';
WITH q AS (SELECT question_id FROM question ORDER BY question_id DESC LIMIT 1)
INSERT INTO choice(question_id, description, is_correct)
...
INSERT INTO question(category_id, description) SELECT category_id, 'Who discovered X-rays?' FROM category WHERE name='Physics';
WITH q AS (SELECT question_id FROM question ORDER BY question_id DESC LIMIT 1)
INSERT INTO choice(question_id, description, is_correct)
...
INSERT INTO question(category_id, description) SELECT category_id, 'Unit of electric current?' FROM category WHERE name='Physics';
WITH q AS (SELECT question_id FROM question ORDER BY question_id DESC LIMIT 1)
INSERT INTO choice(question_id, description, is_correct)
...
INSERT INTO question(category_id, description) SELECT category_id, 'First law of thermodynamics is about?' FROM category WHERE name='Physics';
WITH q AS (SELECT question_id FROM question ORDER BY question_id DESC LIMIT 1)
INSERT INTO choice(question_id, description, is_correct)
...
INSERT INTO question(category_id, description) SELECT category_id, 'Speed of sound in air (m/s)?' FROM category WHERE name='Physics';
WITH q AS (SELECT question_id FROM question ORDER BY question_id DESC LIMIT 1)
INSERT INTO choice(question_id, description, is_correct)
...
INSERT INTO question(category_id, description) SELECT category_id, 'Who formulated laws of motion?' FROM category WHERE name='Physics';
WITH q AS (SELECT question_id FROM question ORDER BY question_id DESC LIMIT 1)
INSERT INTO choice(question_id, description, is_correct)
...
INSERT INTO question(category_id, description) SELECT category_id, 'What is Ohm''s Law?' FROM category WHERE name='Physics';
WITH q AS (SELECT question_id FROM question ORDER BY question_id DESC LIMIT 1)
INSERT INTO choice(question_id, description, is_correct)
...
INSERT INTO question(category_id, description) SELECT category_id, 'Who discovered radioactivity?' FROM category WHERE name='Physics';
WITH q AS (SELECT question_id FROM question ORDER BY question_id DESC LIMIT 1)
INSERT INTO choice(question_id, description, is_correct)
...
INSERT INTO question(category_id, description) SELECT category_id, 'Unit of frequency?' FROM category WHERE name='Physics';
WITH q AS (SELECT question_id FROM question ORDER BY question_id DESC LIMIT 1)
INSERT INTO choice(question_id, description, is_correct)
...
INSERT INTO question(category_id, description) SELECT category_id, 'Who discovered electron?' FROM category WHERE name='Physics';
WITH q AS (SELECT question_id FROM question ORDER BY question_id DESC LIMIT 1)
INSERT INTO choice(question_id, description, is_correct)
...
-- ===== Chemistry =====
INSERT INTO question(category_id, description) SELECT category_id, 'Chemical symbol for Gold?' FROM category WHERE name='Chemistry';
WITH q AS (SELECT question_id FROM question ORDER BY question_id DESC LIMIT 1)
INSERT INTO choice(question_id, description, is_correct)
SELECT q.question_id, x.description, x.correct FROM q, (VALUES ('Au',TRUE),('Ag',FALSE),('Gd',FALSE),('Go',FALSE)) AS x(description,correct);

INSERT INTO question(category_id, description) SELECT category_id, 'H₂O is the chemical formula for?' FROM category WHERE name='Chemistry';
WITH q AS (SELECT question_id FROM question ORDER BY question_id DESC LIMIT 1)
INSERT INTO choice(question_id, description, is_correct)
...
INSERT INTO question(category_id, description) SELECT category_id, 'Atomic number of Carbon?' FROM category WHERE name='Chemistry';
WITH q AS (SELECT question_id FROM question ORDER BY question_id DESC LIMIT 1)
INSERT INTO choice(question_id, description, is_correct)
SELECT q.question_id, x.description, x.correct FROM q, (VALUES ('6',TRUE),('12',FALSE),('8',FALSE),('14',FALSE)) AS x(description,correct);

INSERT INTO question(category_id, description) SELECT category_id, 'pH value of neutral solution?' FROM category WHERE name='Chemistry';
WITH q AS (SELECT question_id FROM question ORDER BY question_id DESC LIMIT 1)
INSERT INTO choice(question_id, description, is_correct)
SELECT q.question_id, x.description, x.correct FROM q, (VALUES ('7',TRUE),('0',FALSE),('14',FALSE),('1',FALSE)) AS x(description,correct);

INSERT INTO question(category_id, description) SELECT category_id, 'Who discovered Oxygen?' FROM category WHERE name='Chemistry';
WITH q AS (SELECT question_id FROM question ORDER BY question_id DESC LIMIT 1)
INSERT INTO choice(question_id, description, is_correct)
...
INSERT INTO question(category_id, description) SELECT category_id, 'Formula for table salt?' FROM category WHERE name='Chemistry';
WITH q AS (SELECT question_id FROM question ORDER BY question_id DESC LIMIT 1)
INSERT INTO choice(question_id, description, is_correct)
...
INSERT INTO question(category_id, description) SELECT category_id, 'Most abundant gas in air?' FROM category WHERE name='Chemistry';
WITH q AS (SELECT question_id FROM question ORDER BY question_id DESC LIMIT 1)
INSERT INTO choice(question_id, description, is_correct)
...
INSERT INTO question(category_id, description) SELECT category_id, 'Who invented the periodic table?' FROM category WHERE name='Chemistry';
WITH q AS (SELECT question_id FROM question ORDER BY question_id DESC LIMIT 1)
INSERT INTO choice(question_id, description, is_correct)
...
INSERT INTO question(category_id, description) SELECT category_id, 'What is the chemical formula for methane?' FROM category WHERE name='Chemistry';
WITH q AS (SELECT question_id FROM question ORDER BY question_id DESC LIMIT 1)
INSERT INTO choice(question_id, description, is_correct)
SELECT q.question_id, x.description, x.correct FROM q, (VALUES ('CH₄',TRUE),('C₂H₆',FALSE),('CO₂',FALSE),('H₂O',FALSE)) AS x(description,correct);

INSERT INTO question(category_id, description) SELECT category_id, 'Which acid is found in vinegar?' FROM category WHERE name='Chemistry';
WITH q AS (SELECT question_id FROM question ORDER BY question_id DESC LIMIT 1)
INSERT INTO choice(question_id, description, is_correct)
...
-- ===== Computer Science =====
INSERT INTO question(category_id, description) SELECT category_id, 'Who invented the World Wide Web?' FROM category WHERE name='Computer Science';
WITH q AS (SELECT question_id FROM question ORDER BY question_id DESC LIMIT 1)
INSERT INTO choice(question_id, description, is_correct)
...
INSERT INTO question(category_id, description) SELECT category_id, 'What does CPU stand for?' FROM category WHERE name='Computer Science';
WITH q AS (SELECT question_id FROM question ORDER BY question_id DESC LIMIT 1)
INSERT INTO choice(question_id, description, is_correct)
...
INSERT INTO question(category_id, description) SELECT category_id, 'Binary of decimal 5?' FROM category WHERE name='Computer Science';
WITH q AS (SELECT question_id FROM question ORDER BY question_id DESC LIMIT 1)
INSERT INTO choice(question_id, description, is_correct)
...
INSERT INTO question(category_id, description) SELECT category_id, 'HTML stands for?' FROM category WHERE name='Computer Science';
WITH q AS (SELECT question_id FROM question ORDER BY question_id DESC LIMIT 1)
INSERT INTO choice(question_id, description, is_correct)
...
INSERT INTO question(category_id, description) SELECT category_id, 'Python is a ___ language?' FROM category WHERE name='Computer Science';
WITH q AS (SELECT question_id FROM question ORDER BY question_id DESC LIMIT 1)
INSERT INTO choice(question_id, description, is_correct)
...
INSERT INTO question(category_id, description) SELECT category_id, 'What is the value of 2^5?' FROM category WHERE name='Computer Science';
WITH q AS (SELECT question_id FROM question ORDER BY question_id DESC LIMIT 1)
INSERT INTO choice(question_id, description, is_correct)
SELECT q.question_id, x.description, x.correct FROM q, (VALUES ('32',TRUE),('16',FALSE),('64',FALSE),('8',FALSE)) AS x(description,correct);

INSERT INTO question(category_id, description) SELECT category_id, 'Which is not a programming language?' FROM category WHERE name='Computer Science';
WITH q AS (SELECT question_id FROM question ORDER BY question_id DESC LIMIT 1)
INSERT INTO choice(question_id, description, is_correct)
...
INSERT INTO question(category_id, description) SELECT category_id, 'What is the output of print(2+3)?' FROM category WHERE name='Computer Science';
WITH q AS (SELECT question_id FROM question ORDER BY question_id DESC LIMIT 1)
INSERT INTO choice(question_id, description, is_correct)
SELECT q.question_id, x.description, x.correct FROM q, (VALUES ('5',TRUE),('23',FALSE),('2+3',FALSE),('None',FALSE)) AS x(description,correct);

INSERT INTO question(category_id, description) SELECT category_id, 'Which company developed Java?' FROM category WHERE name='Computer Science';
WITH q AS (SELECT question_id FROM question ORDER BY question_id DESC LIMIT 1)
INSERT INTO choice(question_id, description, is_correct)
...
INSERT INTO question(category_id, description) SELECT category_id, 'What is the time complexity of binary search?' FROM category WHERE name='Computer Science';
WITH q AS (SELECT question_id FROM question ORDER BY question_id DESC LIMIT 1)
INSERT INTO choice(question_id, description, is_correct)
...
INSERT INTO contact(subject, message, email) VALUES
...
/***
-- ===== Sample queries =====
-- Recent quiz results (newest first) with user & category names, score%
SELECT
  q.quiz_id,
  ...
  q.time_start,
  q.time_end,
  COUNT(qq.qq_id) AS questions,
  AVG(CASE WHEN ch.is_correct THEN 1.0 ELSE 0.0 END) * 100 AS score_percent
FROM quiz q
JOIN "user" u ON u.user_id = q.user_id
JOIN category c ON c.category_id = q.category_id
LEFT JOIN quizquestion qq ON qq.quiz_id = q.quiz_id
LEFT JOIN choice ch ON ch.choice_id = qq.user_choice_id
GROUP BY q.quiz_id, user_full_name, u.email, c.name, q.time_start, q.time_end
ORDER BY q.time_start DESC;

-- Questions with their correct choice
SELECT q.question_id, c.name AS category, q.description,
       (SELECT description FROM choice ch WHERE ch.question_id=q.question_id AND is_correct) AS correct_answer
FROM question q
JOIN category c ON c.category_id = q.category_id
ORDER BY q.question_id;

-- All contact messages (newest first)
SELECT contact_id, subject, email, time, left(message, 60) || CASE WHEN length(message) > 60 THEN '…' ELSE '' END AS preview
FROM contact
ORDER BY time DESC;
